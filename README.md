...
Projeto desenvolvido para o processo seletivo da empresa Supera, teve o objetivo de criar uma página utlizando a biblioteca React com typescript e consumir API feita com Spring Boot, onde seria possível consultar todas a movimentações de uma conta, filtrar por data de inicio, fim, pelo nome do operador transacionado e traz a projeção do saldo total da conta e por período. Com isso foi utlizado a estrutura do react, bem como a utilização dos componentes, routes, props  useState e useEffect.
...
![FrontEnd](https://i.imgur.com/aFPUlpW.gif)

## Como criar e executar o Bank Supera localmente
